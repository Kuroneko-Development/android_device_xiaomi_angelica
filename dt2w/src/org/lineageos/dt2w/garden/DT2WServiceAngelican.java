package org.lineageos.dt2w.angelican;
...
public class DT2WServiceangelican extends Service {
    private static final String TAG = "DT2WServiceangelican";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.angelican.dt2w", dt2wEnabled ? "1" : "0");
        }
